...
#define SCE_AUDIODEC_MP3_MPEG_VERSION_2_5      0
#define SCE_AUDIODEC_MP3_MPEG_VERSION_RESERVED 1
#define SCE_AUDIODEC_MP3_MPEG_VERSION_2        2
#define SCE_AUDIODEC_MP3_MPEG_VERSION_1        3
