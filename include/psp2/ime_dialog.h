...
#define SCE_IME_LANGUAGE_PORTUGUESE_BR       0x00020000ULL
#define SCE_IME_LANGUAGE_ENGLISH_GB          0x00040000ULL
#define SCE_IME_LANGUAGE_TURKISH             0x00080000ULL
...
#define SCE_IME_DIALOG_TEXTBOX_MODE_WITH_CLEAR	2
