...
typedef enum SceJsonError
{
    ...
    SCE_JSON_ERROR_NOFILE               = 0x80920103, //!< Parser failed to load file.
...
public:
     ...
     */
    virtual void* allocateMemory(size_t size, void* data) = 0;
    /**
     ...
     */
    virtual void  notifyError(int code, size_t size, void* data);
};

struct InitParameter
{
    MemAllocator*   allocator; //!< Pointer to a MemAllocator object for internal memory allocations. Required field.
    void*           data;      //!< User defined data sent to overriden functions.
...
public:
     ...
     * 
     * @return The value. Will return false if the Value is not of type ::SCE_JSON_VALUE_BOOL.
     */
    const bool&      getBoolean() const;
    /**
     * Returns a constant reference to the value.
     * 
     * @return The value. Will return 0 if the Value is not of type ::SCE_JSON_VALUE_INT64 or ::SCE_JSON_VALUE_UINT64.
     */
     ...
     * Returns a constant reference to the value.
     * 
     * @return The value. Will return 0 if the Value is not of type ::SCE_JSON_VALUE_REAL.
     */
    const SceDouble& getReal() const;
    /**
     * Returns a constant reference to the string. Only constant functions can be used, and the string cannot be altered.
     * referString() is the alternative function for altering the string.
     * 
     * @return The string. Will return a garbage string if the Value is not of type ::SCE_JSON_VALUE_STRING.
     */
    const String&    getString() const;
    /**
     * Returns a constant reference to the array. Only constant functions can be used, and the array and its members cannot be altered.
     * referArray() is the alternative function for altering the array.
     * 
     * @return The array. Will return an empty array if the Value is not of type ::SCE_JSON_VALUE_ARRAY.
     */
    const Array&     getArray() const;
    /**
     * Returns a constant reference to the object. Only constant functions can be used, and the object and its members cannot be altered.
     * referObject() is the alternative function for altering the array.
     * 
     * @return The object. Will return an empty object if the Value is not of type ::SCE_JSON_VALUE_OBJECT.
     */
    const Object&    getObject() const;

    /**
     * Returns a constant reference to the value. Only constant functions can be used, and the value cannot be altered.
     * referValue(size_t) is the alternative function for altering the value.
     * 
     * @param[in] pos - The position of the value.
     * 
     * @return The value. Will return an empty value if the value doesn't exist.
     */
     ...
     * 
     * @return The value. Will return nullptr if the Value is not of type ::SCE_JSON_VALUE_BOOL.
     */
    bool*       referBoolean();
    /**
     * Returns a pointer to the value.
     * 
     * @return The value. Will return nullptr if the Value is not of type ::SCE_JSON_VALUE_INT64 or ::SCE_JSON_VALUE_UINT64.
     */
    ...
    SceDouble*  referReal();
    /**
     * Returns a pointer to the string. getString() is the alternative function for only reading the string.
     * 
     * @return The string. Will return a garbage string if the Value is not of type ::SCE_JSON_VALUE_STRING.
     */
    String*     referString();
    /**
     * Returns a pointer to the array. getArray() is the alternative function for only reading the array.
     * 
     * @return The array. Will return an empty array if the Value is not of type ::SCE_JSON_VALUE_ARRAY.
     */
    Array*      referArray();
    /**
     * Returns a pointer to the object. getObject() is the alternative function for only reading the object.
     * 
     * @return The object. Will return an empty object if the Value is not of type ::SCE_JSON_VALUE_OBJECT.
     */
    Object*     referObject();
    ...
    /**
     * Returns a pointer to the value. getValue(size_t) is the alternative function for only reading the Value.
     * 
     * @param[in] pos - The position of the value.
     * 
     * @return The value. Will return an empty value if the value doesn't exist.
     */
    Value*      referValue(size_t pos);
    /**
     * Returns a pointer to the value. getValue(String&) is the alternative function for only reading the Value.
     * 
     * @param[in] key - The key of the value.
     * 
     * @return The value. Will return an empty value if the value doesn't exist.
     ...
     * 
     * @param[out] s    - The resulting string, can be written to a file or parsed.
     * @param[in]  cb   - Callback for the internal serialization. 
     *                    Can be used to format the output string, as the string is not formatted internally.
...
public:
    ...
    public:
         ...
         * 
         * @return A reference to the pair the iterator is currently pointing to.
         */
        Pair&       operator*() const;
        /**
...
public:
     ...
     * @param[in]  cb   - The callback function which gives the current character.
