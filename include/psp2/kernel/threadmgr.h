 ...
 *
 * @param clearAttr - attr for clear.
 * @param setAttr - The thread attributes to modify.  One of ::SceThreadAttributes.
 *
 * @return < 0 on error.
 */
 ...
 *
 * @param evfId - The event id returned by ::sceKernelCreateEventFlag
 * @param bitPattern - The bits to clean
 *
 * @return < 0 on Error
 */
...
/**
  ...
  * @param info - Pointer to a status structure. The size parameter should be
  * initialised before calling.
  *
  * @return < 0 on error.
  */
int sceKernelGetCallbackInfo(SceUID cb, SceKernelCallbackInfo *info);
 ...
 *
 * @param threadId - the id of the thread to send a signal to
 * @return 0 on success
...
SceInt32 _sceKernelCancelEventFlag(SceUID evfId, SceUInt32 setPattern, SceUInt32 *pNumWaitThreads);
SceInt32 _sceKernelCancelEventWithSetPattern(SceUID eventId, SceUInt32 setPattern, SceUInt64 userData, SceUInt32 *pNumWaitThreads);
SceInt32 _sceKernelCancelMsgPipe(SceUID msgPipeId, SceUInt32 *pNumSendWaitThreads, SceUInt32 *pNumReceiveWaitThreads);
SceInt32 _sceKernelCancelMutex(SceUID mutexId, SceInt32 newCount, SceUInt32 *pNumWaitThreads);
SceInt32 _sceKernelCancelRWLock(SceUID rwLockId, SceUInt32 *pNumReadWaitThreads, SceUInt32 *pNumWriteWaitThreads, SceInt32 flag);
SceInt32 _sceKernelCancelSema(SceUID semaId, SceInt32 setCount, SceUInt32 *pNumWaitThreads);
SceInt32 _sceKernelCreateLwCond(SceKernelLwCondWork *pWork, const char *pName, SceUInt32 attr, SceKernelLwMutexWork *pLwMutex);
SceInt32 _sceKernelDeleteLwCond(SceKernelLwCondWork *pWork);
SceInt32 _sceKernelDeleteLwMutex(SceKernelLwMutexWork *pWork);
SceInt32 _sceKernelGetCallbackInfo(SceUID callbackId, SceKernelCallbackInfo *pInfo);
SceInt32 _sceKernelGetCondInfo(SceUID condId, SceKernelCondInfo *pInfo);
SceInt32 _sceKernelGetEventFlagInfo(SceUID evfId, SceKernelEventFlagInfo *pInfo);
SceInt32 _sceKernelGetEventPattern(SceUID eventId, SceUInt32 *pPattern);
SceInt32 _sceKernelGetLwCondInfo(SceKernelLwCondWork *pWork, SceKernelLwCondInfo *pInfo);
SceInt32 _sceKernelGetLwCondInfoById(SceUID lwCondId, SceKernelLwCondInfo *pInfo);
SceInt32 _sceKernelGetLwMutexInfoById(SceUID lwMutexId, SceKernelLwMutexInfo *pInfo);
SceInt32 _sceKernelGetMsgPipeInfo(SceUID msgPipeId, SceKernelMsgPipeInfo *pInfo);
SceInt32 _sceKernelGetMutexInfo(SceUID mutexId, SceKernelMutexInfo *pInfo);
SceInt32 _sceKernelGetRWLockInfo(SceUID rwLockId, SceKernelRWLockInfo *pInfo);
SceInt32 _sceKernelGetSemaInfo(SceUID semaId, SceKernelSemaInfo *pInfo);
SceInt32 _sceKernelGetSystemInfo(SceKernelSystemInfo *pInfo);
SceInt32 _sceKernelGetSystemTime(SceKernelSysClock *pClock);
SceInt32 _sceKernelGetThreadInfo(SceUID threadId, SceKernelThreadInfo *pInfo);
SceInt32 _sceKernelGetThreadRunStatus(SceKernelThreadRunStatus *pStatus);
SceInt32 _sceKernelLockLwMutex(SceKernelLwMutexWork *pWork, SceInt32 lockCount, SceUInt32 *pTimeout, SceInt32 fCallback);
SceInt32 _sceKernelLockMutex(SceUID mutexId, SceInt32 lockCount, SceUInt32 *pTimeout);
SceInt32 _sceKernelLockMutexCB(SceUID mutexId, SceInt32 lockCount, SceUInt32 *pTimeout);
SceInt32 _sceKernelLockReadRWLock(SceUID rwLockId, SceUInt32 *pTimeout);
SceInt32 _sceKernelLockReadRWLockCB(SceUID rwLockId, SceUInt32 *pTimeout);
SceInt32 _sceKernelLockWriteRWLock(SceUID rwLockId, SceUInt32 *pTimeout);
SceInt32 _sceKernelLockWriteRWLockCB(SceUID rwLockId, SceUInt32 *pTimeout);
SceInt32 _sceKernelPollEvent(SceUID eventId, SceUInt32 bitPattern, SceUInt32 *pResultPattern, SceUInt64 *pUserData);
SceInt32 _sceKernelPollEventFlag(SceUID evfId, SceUInt32 bitPattern, SceUInt32 waitMode, SceUInt32 *pResultPat);
SceInt32 _sceKernelPulseEventWithNotifyCallback(SceUID eventId, SceUInt32 pulsePattern, SceUInt64 userData, SceInt32 notifyArg);
SceInt32 _sceKernelReceiveMsgPipeVector(SceUID msgPipeId, const SceKernelMsgPipeVector *pVector, SceUInt32 numVector, SceUInt32 waitMode);
SceInt32 _sceKernelReceiveMsgPipeVectorCB(SceUID msgPipeId, const SceKernelMsgPipeVector *pVector, SceUInt32 numVector, SceUInt32 waitMode);
SceInt32 _sceKernelSendMsgPipeVector(SceUID msgPipeId, const SceKernelMsgPipeVector *pVector, SceUInt32 numVector, SceUInt32 waitMode);
SceInt32 _sceKernelSendMsgPipeVectorCB(SceUID msgPipeId, const SceKernelMsgPipeVector *pVector, SceUInt32 numVector, SceUInt32 waitMode);
SceInt32 _sceKernelSetEventWithNotifyCallback(SceUID eventId, SceUInt32 setPattern, SceUInt64 userData, SceInt32 notifyArg);
SceInt32 _sceKernelSignalLwCond(SceKernelLwCondWork *pWork);
SceInt32 _sceKernelSignalLwCondAll(SceKernelLwCondWork *pWork);
SceInt32 _sceKernelSignalLwCondTo(SceKernelLwCondWork *pWork, SceUID threadId);
SceInt32 _sceKernelStartThread(SceUID threadId, SceSize argSize, const void *pArgBlock);
SceInt32 _sceKernelTryReceiveMsgPipeVector(SceUID msgPipeId, const SceKernelMsgPipeVector *pVector, SceUInt32 numVector, SceUInt32 waitMode);
SceInt32 _sceKernelTrySendMsgPipeVector(SceUID msgPipeId, const SceKernelMsgPipeVector *pVector, SceUInt32 numVector, SceUInt32 waitMode);
SceInt32 _sceKernelUnlockLwMutex(SceKernelLwMutexWork *pWork, SceInt32 unlockCount);
SceInt32 _sceKernelWaitCond(SceUID condId, SceUInt32 *pTimeout);
SceInt32 _sceKernelWaitCondCB(SceUID condId, SceUInt32 *pTimeout);
SceInt32 _sceKernelWaitEvent(SceUID eventId, SceUInt32 waitPattern, SceUInt32 *pResultPattern, SceUInt64 *pUserData);
SceInt32 _sceKernelWaitEventCB(SceUID eventId, SceUInt32 waitPattern, SceUInt32 *pResultPattern, SceUInt64 *pUserData);
SceInt32 _sceKernelWaitEventFlag(SceUID evfId, SceUInt32 bitPattern, SceUInt32 waitMode, SceUInt32 *pResultPat);
SceInt32 _sceKernelWaitEventFlagCB(SceUID evfId, SceUInt32 bitPattern, SceUInt32 waitMode, SceUInt32 *pResultPat);
SceInt32 _sceKernelWaitLwCond(SceKernelLwCondWork *pWork, SceUInt32 *pTimeout);
SceInt32 _sceKernelWaitLwCondCB(SceKernelLwCondWork *pWork, SceUInt32 *pTimeout);
SceInt32 _sceKernelWaitMultipleEvents(SceKernelWaitEvent *pWaitEventList, SceInt32 numEvents, SceUInt32 waitMode, SceKernelResultEvent *pResultEventList);
SceInt32 _sceKernelWaitMultipleEventsCB(SceKernelWaitEvent *pWaitEventList, SceInt32 numEvents, SceUInt32 waitMode, SceKernelResultEvent *pResultEventList);
SceInt32 _sceKernelWaitSema(SceUID semaId, SceInt32 needCount, SceUInt32 *pTimeout);
SceInt32 _sceKernelWaitSemaCB(SceUID semaId, SceInt32 needCount, SceUInt32 *pTimeout);
SceInt32 _sceKernelWaitSignal(SceInt64 option, SceUInt32 *pTimeout);
SceInt32 _sceKernelWaitSignalCB(SceInt64 option, SceUInt32 *pTimeout);
SceUID _sceKernelCreateCond(const char *pName, SceUInt32 attr, SceUID mutexId, const SceKernelCondOptParam *pOptParam);
...
SceUID _sceKernelCreateRWLock(const char *pName, SceUInt32 attr, const SceKernelRWLockOptParam *pOptParam);
SceUID _sceKernelCreateSema(const char *pName, SceUInt32 attr, SceInt32 initCount, SceInt32 maxCount);
SceUID _sceKernelCreateSimpleEvent(const char *pName, SceUInt32 attr, SceUInt32 initPattern, const SceKernelSimpleEventOptParam *pOptParam);
SceInt32 _sceKernelPMonThreadGetCounter(SceUID threadId, SceUInt32 counter, SceUInt32 *pCount);

SceInt32 sceKernelChangeActiveCpuMask(SceUInt32 activeCpuMask);
