...
_GLIBCXX_BEGIN_NAMESPACE_VERSION
    ...
    class _Iosb
    {
      public:
        ...
        { 
          ...
          _S_failbit		= 1L << 1,
          _S_badbit 		= 1L << 2,
          _S_Iostate_end = 1L << 16 
        };
    };

  inline _GLIBCXX_CONSTEXPR _Iosb<int>::_Iostate
  operator&(_Iosb<int>::_Iostate __a, _Iosb<int>::_Iostate __b)
  { return _Iosb<int>::_Iostate(static_cast<int>(__a) & static_cast<int>(__b)); }
  ...
  inline _GLIBCXX_CONSTEXPR _Iosb<int>::_Iostate
  operator~(_Iosb<int>::_Iostate __a)
  { return _Iosb<int>::_Iostate(~static_cast<int>(__a)); }

  inline const _Iosb<int>::_Iostate&
  operator|=(_Iosb<int>::_Iostate& __a, _Iosb<int>::_Iostate __b)
  { return __a = __a | __b; }
  ...
  */
  ...
  public:
    ...
    */
     ...
     *  @brief This is a bitmask type.
     *
     *  @c @a _Iosb<int>::_Iostate is implementation-defined, but it is valid to
     *  perform bitwise operations on these values and expect the Right
     ...
     *  - goodbit
    */
    typedef _Iosb<int>::_Iostate iostate;
